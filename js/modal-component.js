...
const SpiriaModal = () => (
    <div className="col-md-8 col-md-offset-2">
        ...
        <h4>Orthoacademie</h4> 
        <br/>
        <img src="img/portfolio/SP-orthoacademie.jpg" alt="Aidexpress presentation" className="img-responsive" />
        <br/>
        <p><a href="https://www.orthoacademie.com/" target="_">Orthoacademie</a> is a wonderful online institute where students can be trained in massage and orthotherapy. I had the privilege of working directely with the founder Veronique Paré, visiting her institute in Gatineau, and conducting usability testing with her students.
            When Spiria took on redisigning Orthoacademie, I started with an audit for the existing platform, conducted interviews with current students who used the online platform to better understand some of the problems they encountered. Accordingly, I created personas, new information architecture and low fidelity wireframes that were handed off to visual design.</p>
        <br/> 
        <h4>Arc Depot</h4> 
        <br/>
        <img src="img/portfolio/SP-Arc-depot.jpg" alt="Arc Depot home" className="img-responsive" />
        <br/>
        <p><a href="https://arc-depot.com/" target="_">Arc Depot</a> is an E-commerce platform for welding supplies. I met the client with product managers, collected requirements, interviewed users and created personas to represent them. I created scenarios for the different tasks the client wanted users to acheive. From scenarios, I defined the information architecture of
         the site and we built it with a Shopify theme. After implementation we conducted a usabiltiy session to verify the organization, information architecture and that users are able to acheive their main goals through the site. </p>
        <br/>
        ...
        <p>I had the opportunity to design multiple mobile projects that are under NDA. This includes: </p>
            <ul>
            <li>"Enfant Soleil/Extra Life" an event app.</li>
            <li>"FCS control" for Entice Development group. </li>
            <li>"OnSpot" a home inspection app for Urban Studies.</li>
            <li>"REO" a real estate responsive web app for NextGen. </li>
            </ul>
        <br/>
        </div>
);
...
<div className="col-md-8 col-md-offset-2">
    ...
    <div className="h-50"></div>
    <p>I was approached as a freelancer to design this app while still a student at Algonquin College. The app is currently available on Apple and Google stores and can be accessed <a href="https://touchplow.com/" target="_">here.</a>
    <br/>We began the design process with several discovery workshops with the client to collect business goals and requirements.
       His vision was to make this app the "Uber" of snow removal and lawn moving. He wanted to create native apps for both iOS and Android. At the time the app name was "SnowMowz" as it was intended to switch between
        ...
        <br/>
        <br/>After defining the requirements and two primary personas of the application (the home owner and the service provider), I started defining user journeys and information architecture. During the visual design phase, my focus
       ...
       <br/><br/> The visual designs presented here are of course <b>very old</b> since they were <b>created in 2015</b> but beleive me they reflected Apple and google interfaces and guidelines at that time. Below are a few example flows.
       </p>
    <h4>iOS Login &amp; Homepage</h4>
    <img src="img/portfolio/Touchplow-ios-login.jpg" alt="touchplow ios login" className="img-responsive" />
    <h4>Providers' iOS Interface</h4>
    <img src="img/portfolio/Touchplow-ios-provider.jpg" alt="touchplow ios provider" className="img-responsive" />
    <h4>Android new customer form</h4>
    <img src="img/portfolio/Touchplow-Android-form.jpg" alt="touchplow Android new customer form" className="img-responsive" />
    <h4>Android request service </h4>
    <img src="img/portfolio/Touchplow-Android-request-service-1.jpg" alt="touchplow Android request service 1" className="img-responsive" />
    <img src="img/portfolio/Touchplow-Android-request-service-2.jpg" alt="touchplow Android request service 2" className="img-responsive" />
    <br/>
</div>
)
